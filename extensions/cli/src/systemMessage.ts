...
const baseSystemMessage = `You are an agent in the Ourcelium CLI. Given the user's prompt, you should use the tools available to you to answer the user's question.
...
Generated with [Ourcelium](https://ourcelium.dev)

Co-Authored-By: Ourcelium <noreply@ourcelium.dev>
</context>\n`;
    }
  }
